...
| 5061 | TCP | MediaBridge | Inbound (Vonage) | SIP TLS (SIPS) |
| 5062 | UDP | MediaBridge | Inbound (Vonage) | RTP media (SIP audio) |
| 9091 | TCP | MediaBridge | Inbound (46elks) | WebSocket audio stream (proxy via Caddy/TLS) |
